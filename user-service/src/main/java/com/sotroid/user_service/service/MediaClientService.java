...
import com.sotroid.user_service.dto.response.MediaUploadResponse;
import com.sotroid.user_service.util.MultipartInputStreamFileResource;
...
public class MediaClientService {
    ...
    public String uploadToMediaService(MultipartFile file) {
        ...
        try {
            ...
            response = restTemplate.postForEntity( mediaServiceUrl + "/api/media/upload",
                    request,
